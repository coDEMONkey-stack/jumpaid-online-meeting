...
<head>
  ...
  <meta content="Jumpa.ID" name="ilham 087784873757">
  <!-- Anti Copas --> 
  <!--
  <script>
...
<body>
  ...
  <!-- 
**************************************************
* Disable Text & Image onDrag - Dynamic DHTML *
**************************************************-->
       ...
       <div class=   col-6 justify-content-center d-flex >
         <!-- <div class="col-lg-5 col-xs-10 align-items-center"> -->
          ...
          <!--  <p class="text-center"> /** < ?= $global['fixed_content'] */?> </p> -->
            <p class="text-center"> <p style="font-size: 18px;"><b>Jumpa.id</b> adalah platform Konferensi video daring & sedaring / webinar dari pengembang lokal dengan kecepatan internet minimum 32kbps untuk video dan 16kbps untuk audio dengan kualitas baik dan JELAS, sehingga hemat bandwidth / kuota data internet hingga 93% dibandingkan dengan platform konferensi video non-lokal. Resmi terdaftar di Direktorat Tata Kelola Aplikasi Informatika Kominfo RI <br>
                <a href="https://pse.kominfo.go.id/tdpse-detail/122">https://pse.kominfo.go.id/tdpse-detail/122</a></p>
            ...
            <div class="row">
             ...
             <div class="col-xs-6 col-sm-4">
                <img src="<?=base_url('assets/images/new_all_icons-header-jumpa_id.png')?>" title="Keunggulan Platform Jumpa.id"  style="max-width:350px; max-height:220px;" onClick="window.location.href='#keunggulan'"> </div>
                <br>
          ...
          <!--  <div class="col-md-6 col-xs-12 ">  w-auto p-3 -->
            ...
            <br>
            <br><div class="info">
              <img src="<?= base_url('assets/') ?>images/icon-login.png" style="max-width: 100%; height=auto;"></div>
