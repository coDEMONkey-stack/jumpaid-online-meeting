        ...
        <div class="col-12">
            <div class="box">
                <div class="box-header with-border">
                    <h4 class="box-title">Formulir Edit Banner</h4>
                </div>
                <!-- /.box-header -->
                <form class="form" method="POST" action="<?= base_url('banner/do_edit/' . $data['id']) ?>" enctype="multipart/form-data">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <label class="file">
                                ...
                                <img id="image-now" alt="image preview" style="max-width:250px" src="<?= base_url('assets/images/single_banner/' . $data['gambar']) ?>" /><br><br>
