				...
				<div class="d-inline-block align-items-center">
					<nav>
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item active" aria-current="page">Pesanan Customer</li>
						</ol>
					</nav>
				</div>
			</div>
		...
		<div class="col-12">
			<div class="box">
				...
				<div class="box-header with-border">
					<h3 class="box-title">Data Pesanan Customer</h3>
				</div>
				<!-- /.box-header -->
				<div class="box-body">
							...
							<tbody>
								...
								foreach ($data as $row) : ?>
									<tr id="delete<?= $row->id; ?>">
										...
										<td>
											<a onclick="swdel('message','del',<?php echo $row->id ?>)" class="btn btn-danger"><i class="fa fa-trash"></i></a>
										</td>
									</tr>
								<?php endforeach ?>
							</tbody>
