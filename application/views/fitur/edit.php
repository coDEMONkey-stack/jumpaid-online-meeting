                ...
                <div class="d-inline-block align-items-center">
                    <nav>
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item" aria-current="page">Fitur</li>
        ...
        <div class="col-12">
            <div class="box">
                <div class="box-header with-border">
                    <h4 class="box-title">Formulir Edit Fitur</h4>
                </div>
                <!-- /.box-header -->
                <form class="form" method="POST" action="<?= base_url('fitur/do_edit/' . $data['id']) ?>" enctype="multipart/form-data">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <label class="file">
                                ...
                                <img id="image-now" alt="image preview" style="max-width:250px" src="<?= base_url('assets/images/fitur/' . $data['gambar']) ?>" /><br><br>
                    ...
                    <div class="box-footer">
                        ...
                        <a href="<?= base_url('fitur') ?>" class="btn btn-warning mr-1">
                            Back
                        </a>
                    </div>
                </form>
