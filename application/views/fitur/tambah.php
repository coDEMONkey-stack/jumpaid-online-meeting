        ...
        <div class="col-12">
            <div class="box">
                <div class="box-header with-border">
                    <h4 class="box-title">Formulir Tambah Fitur</h4>
                </div>
                <!-- /.box-header -->
                <form class="form" method="POST" action="<?= base_url('fitur/do_tambah') ?>" enctype="multipart/form-data">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="deskripsi" value="<?= set_value('deskripsi') ?>">
